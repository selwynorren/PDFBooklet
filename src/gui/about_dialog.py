...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(self.tr("About PDF Booklet"))
        ...
        # License button
        license_button = QPushButton(self.tr("License"))
    ...
    def _load_license_text(self):
        ...
        try:
            ...
            return self.tr("LICENSE file not found.")
        except Exception as e:
            return self.tr("Error reading LICENSE file:") + f" {e}"

    def show_license(self):
        """Displays the license in a new dialog."""
        license_dialog = QDialog(self)
        license_dialog.setWindowTitle(self.tr("License"))
